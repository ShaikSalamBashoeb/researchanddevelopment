...
public class EmployeeServiceServiceLocator extends org.apache.axis.client.Service implements com.adp.EmployeeServiceService {
    ...
    private java.lang.String EmployeeServicePort_address = "http://localhost:1234/EmployeeTestService";
    ...
    public com.adp.EmployeeService getEmployeeServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.adp.EmployeeService getEmployeeServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.adp.EmployeeServicePortBindingStub _stub = new com.adp.EmployeeServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.adp.EmployeeService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.adp.EmployeeServicePortBindingStub _stub = new com.adp.EmployeeServicePortBindingStub(new java.net.URL(EmployeeServicePort_address), this);
                _stub.setPortName(getEmployeeServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://adp.com/", "EmployeeServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://adp.com/", "EmployeeServicePort"));
        }
